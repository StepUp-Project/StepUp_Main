    ...
    <main>
        <article id="board_write">
            ...
            <form method="post" action="notice_modify.do">
                ...
                <textarea id="summernote"	 name="noticeCnt" >${vo.noticeCnt}</textarea>
                <div id="board_button">
                    <input type="submit" value="저 장" onclick="return confirm('저장하시겠습니까?')">
                    <input type="button" value="돌아가기" onclick="location.href='notice_view.do?noticeIndex=${vo.noticeIndex}'">
                </div>
            </form>
        </article> 
        <script>
