...
<body>
    ...
    <main class="d-flex justify-content-between "><!--메인 시작-->
        <article id="prd_filter">
        	<input type ="hidden" value="${searchVO.searchType}" name="searchType"/>
            <div id="prd_addr">
                <a href="#">HOME</a>
                <span> > </span>
                <a href="#">BRAND</a>
            ...
            <div id="prc_check">
				<fieldset class="price-range-slider">
					<div class="price-field">
						<input type="range" min="10000" max="178000" value="10000" id="lower">
						<input type="range" min="10000" max="178000" value="178000" id="upper">
					</div>
					<div class="price-wrap align-items-baseline justify-content-end">
						<input disabled id="price-min" name="priceMin">
						<span>~</span>
						<input disabled id="price-max" name="priceMax">
						<span>원</span>
					</div>								
				</fieldset>			
            </div>
