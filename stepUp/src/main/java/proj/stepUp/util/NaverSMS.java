...
public class NaverSMS {
	...
	public String sendSMS(String userPhone) throws JSONException, UnsupportedEncodingException {
		...
		String accessKey = "F0fi6AGBG3oQz3tyjG7c";                     	// 네이버 클라우드 플랫폼 회원에게 발급되는 개인 인증키			// Access Key : https://www.ncloud.com/mypage/manage/info > 인증키 관리 > Access Key ID
		String secretKey = "sjNkMTTpew7aEOmLfXrwjtMHaBuB53h8tJZ5pKRC";  // 2차 인증을 위해 서비스마다 할당되는 service secret key	// Service Key : https://www.ncloud.com/mypage/manage/info > 인증키 관리 > Access Key ID	
		String serviceId = "ncp:sms:kr:304747387946:stepup";       // 프로젝트에 할당된 SMS 서비스 ID							// service ID : https://console.ncloud.com/sens/project > Simple & ... > Project > 서비스 ID
